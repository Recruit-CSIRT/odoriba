...
# [customized] this module is customized http base cuckoo agent.
#              additional function is below of ####   custom   #####
...
####   custom   #####
def windows_time_sync():
    print "windows time updated" 
    w32tm = subprocess.check_output(['net','start','w32time'])
    resync = subprocess.check_output(['w32tm','/resync'])
    return 0
############################
